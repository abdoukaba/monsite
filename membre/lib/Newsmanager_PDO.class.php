 ...
 */ 
  ...
  */ 
  ...
  titre = :titre, contenu = :contenu, dateAjout = NOW(), dateModif = NOW()'); 
  ...
  */ 
  ...
  (dateModif, \'le %d/%m/%Y à %Hh%i\') AS dateModif FROM news ORDER BY id DESC';    
  ...
  */  public function getUnique($id)  
  ...
  contenu, DATE_FORMAT (dateAjout, \'le %d/%m/%Y à %Hh%i\') AS dateAjout, 
  DATE_FORMAT (dateModif, \'le %d/%m/%Y à %Hh%i\') AS dateModif FROM news WHERE id = :id');  
 ...
 */  
 ...
 titre = :titre, contenu = :contenu, dateModif = NOW() WHERE id = :id');      
 $requete->bindValue(':titre', $news->titre());    
 $requete->bindValue(':auteur', $news->auteur());  
 $requete->bindValue(':contenu', $news->contenu());  
